...
export class StompService {
  ...
  // when I attempted to put the 'this.url' the connection didn't work, when I hard coded it worked
  // I know this is stupid because they're exactly the same but it worked :)
